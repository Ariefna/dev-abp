<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        ...
        @foreach($gudang as $gd)
            <div class="modal fade bd-example-modal-xl" id="exampleModal-{{ $gd->id_gudang }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3 needs-validation" action="{{ route('gudang-muat.update', ['gudang_muat' => $gd->id_gudang]) }}"  method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="col-md-6">
                                    <label for="validationCustom01" class="form-label">Nama Gudang</label>
                                    <input name="nama_gd" type="text" value="{{ $gd->nama_gudang }}" class="form-control" id="validationCustom01" placeholder="Masukkan nama gudang" required>
                                    <div class="invalid-feedback">
                                        Form nama gudang tidak boleh kosong
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="validationCustom04" class="form-label">Nama Kota Gudang Muat</label>
                                    <div class="input-group has-validation">
                                        <input name="kota_gd" type="text" value="{{ $gd->kota }}" class="form-control" id="validationCustom04" placeholder="Masukkan nama kota gudang muat" required>
                                        <div class="invalid-feedback">
                                            Form nama kota gudang muat tidak boleh kosong
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <label for="validationCustom03" class="form-label">Alamat</label>
                                    <input name="alamat_gd" type="text" value="{{ $gd->alamat }}" class="form-control" id="validationCustom03" placeholder="Masukkan alamat" required>
                                    <div class="invalid-feedback">
                                        Form alamat tidak boleh kosong
                                    </div>
                                </div>
            ...
            <div class="modal fade bd-example-modal-l" id="exampleModalHps-{{ $gd->id_gudang }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            <h5>Apakah anda yakin ingin hapus data ini?</h5>
                            <form class="row g-3 needs-validation" action="{{ route('gudang-muat.destroy', ['gudang_muat' => $gd->id_gudang]) }}"  method="POST">
                                @method('DELETE')
                                @csrf
