    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Data Port Of Loading</li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->        
                ...
                <div class="widget-header">                                
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Form Data Port Of Loading</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('pol.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Nama Port Of Loading</label>
                            <input name="nama_pol" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan nama Port Of Loading" required>
                            <div class="invalid-feedback">
                                Form nama Port Of Loading tidak boleh kosong
                            </div>
                        </div>
                        <div class="col-12">
        ...
        <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">                                
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Tabel Master Data Port Of Loading</h4>
                        </div>
                    </div>
                </div>
...
=======
                                                @if(in_array('master-pol-UPDATE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
                                                                <li><a href="javascript:void(0);" class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 p-1 br-8 mb-1">
                                                                            <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                                                                        </svg></a></li>
                                                                @endif
                                                                @if(in_array('master-pol-DELETE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
            ...
            <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        ...
                        <form class="row g-3 needs-validation" action="{{ route('pol.destroy', ['pol' => $pl->id]) }}"  method="POST">
                            @method('DELETE')
                            @csrf
