<x-base-layout :scrollspy="false">
    ...
    <div class="cs-overlay"></div> --}}
                            ...
                            <div class="widget-content widget-content-area" style="padding: 1.5%;">
                                <form class="row g-3 needs-validation" action="{{ route('purchase-order.store') }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="po_muat" type="text" class="form-control" id="validationCustom01"
                                            placeholder="Masukkan PO Muat" required>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="po_kebun" type="text" class="form-control" id="validationCustom01"
                                            placeholder="Masukkan PO Kebun" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input name="no_pl" type="text" class="form-control" id="validationCustom01"
                                            placeholder="Masukkan PO Kebun" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input name="simb" type="text" class="form-control" id="validationCustom01"
                                            placeholder="Masukkan SIMB jika perlu">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input name="qty" type="number" step="any" value="0" min="0"
                                            class="form-control" id="t_qty" placeholder="Masukkan quantity Contoh:1"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationCustom03" class="form-label">Unit Price (IDR)
                                            Curah</label>
                                        <input readonly name="price_curah" type="text" value="0" class="form-control"
                                            id="oa_kpl_kayu" placeholder="Masukkan Harga" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationCustom03" class="form-label">Amount (IDR) Curah</label>
                                        <input readonly name="total_curah" type="text" value="0" class="form-control"
                                            id="am_kayu" placeholder="Masukkan Harga Total" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationCustom03" class="form-label">Quantity Kapal
                                            Container</label>
                                        <input name="qty2" type="number" step="any" value="0" class="form-control"
                                            id="t_qty2" placeholder="Masukkan Quantity" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="validationCustom03" class="form-label">Unit Price (IDR)
                                            Container</label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input readonly name="total_qty" step="any" type="number" value="0"
                                            class="form-control" id="total_qty" placeholder="Masukkan Quantity"
                                            required>
                                    </div>

                                    <div class="col-md-6">
                                        <label for="validationCustom03" class="form-label">Total Amount (IDR)</label>
                                        <input readonly name="total_all" type="text" value="0" class="form-control"
                                            id="total_all" placeholder="Masukkan Total Amount" required>
                                    </div>
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <table id="style-3" class="table style-3 dt-table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{!! $p->status == 2 ? '<span
                                                    class="shadow-none badge badge-success">Approved</span>' :
                                                ($p->status == 1 ? '<span class="shadow-none badge badge-warning">Not
                                                    Approved</span>' : '') !!}</td>
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    ...
                                                    'superadmin')
                                                    <li><a href="#edit-{{ $p->id_po }}" class="bs-tooltip"
                                                            data-bs-toggle="modal" data-bs-placement="top" title="Edit"
                                                    ...
                                                    @if (in_array('document-purchase-order-APPROVE',
                                                    Session::get('nama_action')) || Session::get('role') ==
                                                    'superadmin')
                                                    {!! $p->status == 1
                                                    ? '<a href="' .
                                                    ...
                                                    : '') !!}
                                                    @endif
                                                    @if (in_array('document-purchase-order-DELETE',
                                                    Session::get('nama_action')) || Session::get('role') ==
                                                    'superadmin')
                                                    <li><a href="#exampleModalHps-{{ $p->id_po }}" class="bs-tooltip"
                                                    ...
                                                    '<li><a href="'.route('downloadpo', ['path' => $p->file_name]).'"
                                                            ...
                                                            data-bs-placement="top" title="Download PO"
                                ...
                                <td class="text-center">
                                    <ul class="table-controls">
                                        @if (in_array('document-purchase-order-UPDATE', Session::get('nama_action')) ||
                                        ...
                                        @endif
                                        @if (in_array('document-purchase-order-APPROVE', Session::get('nama_action')) ||
                                        Session::get('role') == 'superadmin')
                                        {!! $p->status == 1
                                        ? '<a href="' .
                                                                                route('purchase-order.approve', ['po_muat' => $p->po_muat]) .
                                                                                '" id="approve-link" class="bs-tooltip"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Approve"
                                            data-original-title="Approve"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        : '') !!}
                                        @endif
                                        @if (in_array('document-purchase-order-DELETE', Session::get('nama_action')) ||
                                        Session::get('role') == 'superadmin')
                                        <li><a href="javascript:void(0);" class="bs-tooltip" data-bs-toggle="tooltip"
                ...
                @foreach ($po as $p)
                <div class="modal fade bd-example-modal-xl" id="edit-{{ $p->id_po }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="row g-3 needs-validation"
                                    action="{{ route('purchase-order.update', ['purchase_order' => $p->id_po]) }}"
                                    method="POST" enctype="multipart/form-data" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="col-md-12">
                                        <label for="validationCustom01" class="form-label">No PO</label>
                                        <input readonly name="no_po" type="text" value="{{ $p->po_muat }}"
                ...
                <div class="modal fade bd-example-modal-l" id="exampleModalHps-{{ $p->id_po }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                ...
                                <form class="row g-3 needs-validation"
                                    action="{{ route('purchase-order.destroy', ['purchase_order' => $p->id_po]) }}"
                                    method="POST">
                                    @method('DELETE')
                                    @csrf
                ...
                <x-slot:footerFiles>
                    ...
                    $(document).ready(function() {
                        ...
                        function exportTableToExcelByRow(tableId, filename, noPO) {
                            ...
                            ws = XLSX.utils.json_to_sheet(selectedData);
                        ...
                        $('#validationDefault01').change(function() {
                            ...
                            if (selectedId !== '') {
                                $.ajax({
                                    url: "{{ route('getCustomerDetails', ['id' => ':id']) }}"
                                        .replace(':id',
                                            selectedId),
                                    type: 'GET',
                                    dataType: 'json',
                                    success: function(response) {
                                        ...
                                        if (response.length > 0) {
                                            ...
                                            for (var i = 0; i < response.length; i++) {
                                                var optVal = response[i].id_penawaran + '' +
                                                    response[i]
                                                    .id_pt_penerima;
                                    ...
                                    success: function(response) {
                                        ...
                                        if (response.length > 0) {
                                            ...
                                            for (var i = 0; i < response.length; i++) {
                                                ...
                                                $('#oa_kpl_kayu').val(formatter.format(
                                                    response[i]
                                                    .oa_kpl_kayu));
                                                $('#oa_container').val(formatter.format(
                                                    response[i]
                                                    .oa_container));
                                                var price_curah = response[i].oa_kpl_kayu;
                                                var price_container = response[i]
                                                    .oa_container;

                                                if (price_curah == 0 && price_container !=
                                                    0) {
                                                    $('input[name=qty]').attr("readonly",
                                                        "readonly");
                                                    $('input[name="qty2"]').removeAttr(
                                                        "readonly");
                                                    console.log('price_curah : ' +
                                                        price_curah);
                                                } else if (price_container == 0 &&
                                                    price_curah != 0) {
                                                    $('input[name=qty2]').attr("readonly",
                                                        "readonly");
                                                    $('input[name="qty"]').removeAttr(
                                                        "readonly");
                                                    console.log('price_container : ' +
                                                        price_container);
                                                } else if (price_curah != 0 &&
                                                    price_container != 0) {
                                                    $('input[name="qty"]').removeAttr(
                                                        "readonly");
                                                    $('input[name="qty2"]').removeAttr(
                        ...
                        $('#t_qty, #t_qty2, #oa_kpl_kayu, #oa_container, #qty_curah,#qty_cont').on('input',
                            updateValues);
                        updateValues();
