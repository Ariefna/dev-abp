                ...
                <div class="row layout-top-spacing">
                                ...
                                <table id="tbl_1" class="table tbl_1 dt-table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{!! $phs->status == 2 ? '<span
                                                    class="shadow-none badge badge-success">Approved</span>' :
                                                ($phs->status == 3 ? '<span class="shadow-none badge badge-warning">Not
                                                    Approved</span>' : '') !!}</td>
                                            <td class="text-center">
                                                @if (in_array('document-penawaran-harga-UPDATE',
                                                Session::get('nama_action')) || Session::get('role') == 'superadmin')
                                                <a href="{{ route('penawaran-harga.edit', ['id_penawaran' => $phs->id_penawaran]) }}"
                                                ...
                                                @endif
                                                @if (in_array('document-penawaran-harga-APPROVE',
                                                Session::get('nama_action')) || Session::get('role') == 'superadmin')
                                                {!! $phs->status == 3 ? '<a
                                                    href="'. route('penawaran-harga.approve', ['id_penawaran' => $phs->id_penawaran]) .'"
                                                    id="approve-link" class="bs-tooltip" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Approve"
                                                    data-original-title="Approve"><svg
                                                        xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                ...
                                                @endif
                                                <a href="{{route('penawaran-harga.generatepdf', ['id_penawaran' => $phs->id_penawaran])}}"
                                                    class="bs-tooltip" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" disabled style="padding: 1.5%;">
                                <form class="row g-3 needs-validation" disabled
                                    action="{{ route('penawaran-harga.save') }}" method="POST"
                                    enctype="multipart/form-data" novalidate>
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="validationCustom01" class="form-label">Nama </label>
                                        <input name="nama_pic" id="nama_cst" type="text" class="form-control"
                                            id="validationCustom03" placeholder="Masukkan nama" required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="alamat_cst" id="alamat" type="text" class="form-control"
                                            id="validationCustom03" placeholder="Masukkan alamat" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <input type="text" style="display: none;" name="id_detail"
                                        value="{{ $dt->id_detail_ph }}">
                                    @endforeach
                                    <div class="col-12">
                                        @if (count($ph->where('status', 1)) >= 1)
                                        <button class="btn btn-primary" disabled type="submit">Selesaikan terlebih
                                            dahulu form penawaran harga</button>
                                        @else
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><span
                                                                class="shadow-none badge badge-danger">{{ $phs->status == 1 ? 'Pending' : '' }}</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <ul class="table-controls">
                                                                <li><a href="#editph-{{ $phs->id_penawaran }}"
                                                                ...
                                                                <li><a href="#hapusph-{{ $phs->id_penawaran }}"
                                                                        class="bs-tooltip" data-bs-toggle="modal"
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="padding: 1.5%;">
                                <form class="row g-3 needs-validation" action="{{ route('penawaran-harga.store') }}"
                                    ...
                                    @foreach ($detail as $dt)
                                    <input type="text" style="display: none;" name="id_ph"
                                        value="{{ $dt->id_penawaran }}">
                                    @endforeach
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="oa_kk" type="number" value="0" class="form-control"
                                            id="validationCustom01" placeholder="Masukkan harga" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="oa_cont" type="number" value="0" class="form-control"
                                            id="validationCustom01" placeholder="Masukkan harga" required>
                                        <div class="invalid-feedback">
                                            Form harga tidak boleh kosong
                                        </div>
                                            ...
                                            <table id="tbl_3" class="table tbl_3 dt-table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $dtl->estate }}</td>
                                                        <td>Rp.
                                                            {{ number_format((float)preg_replace("/[^0-9]/", "", $dtl->oa_kpl_kayu), 0, ',', '.') }}
                                                        </td>
                                                        <td>Rp.
                                                            {{ number_format((float)preg_replace("/[^0-9]/", "", $dtl->oa_container), 0, ',', '.') }}
                                                        </td>
                                                        <td class="text-center"><span
                                                                class="shadow-none badge badge-danger">{{ $dtl->status == 1 ? 'Pending' : '' }}</span>
                                                        </td>
                                                        <td class="text-center">
                                                            <a href="#editphd-{{ $dtl->id_detail_ph }}"
                                                                class="bs-tooltip" data-bs-toggle="modal"
                                                                data-bs-placement="top" title="Edit"
                                                                data-original-title="Edit"><svg
                                                            ...
                                                            <a href="#hapusphd-{{ $dtl->id_detail_ph }}"
                                                                class="bs-tooltip" data-bs-toggle="modal"
                                                                data-bs-placement="top" title="Delete"
                                                                data-original-title="Delete"><svg
                                                                    xmlns="http://www.w3.org/2000/svg" width="26"
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        ...
                        <form class="row g-3 needs-validation"
                            action="{{ route('penawaran-harga.destroy', ['penawaran_harga' => $dt->id_penawaran]) }}"
                            method="POST" enctype="multipart/form-data" novalidate>
                            @method('DELETE')
                            @csrf
                            @if (count($ph->where('status', 1)) >= 1 && count($detailph->where('status', 1 )) >= 1)
                    ...
                    {{-- modal edit & hapus --}}
                    @foreach ($ph as $phs)
                    <div class="modal fade bd-example-modal-xl" id="editph-{{ $phs->id_penawaran }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('penawaran-harga.updateph', ['id_penawaran' => $phs->id_penawaran]) }}"
                                        method="POST" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">Nama </label>
                                            <input name="nama_pic" value="{{ $phs->nama_pic }}" id="nama_cst"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="cst_id" class="form-select" id="cbe_cst" required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($customer as $cst)
                                                <option {{ $cst->id == $phs->id ? 'selected' : '' }}
                                                    value="{{ $cst->id }}">{{ $cst->nama_customer }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                Pilih customer terlebih dahulu
                                        ...
                                        <div class="col-md-12">
                                            <label for="validationCustom03" class="form-label">Alamat</label>
                                            <input name="alamat_cst" value="{{ $phs->alamat }}" id="e_alamat"
                                                type="text" class="form-control" id="validationCustom03"
                                        ...
                                        <div class="col-md-12">
                                            <label for="validationCustom03" class="form-label">Ketentuan</label>
                                            <textarea name="kt" class="form-control" id="t_ktt" rows="10"
                                                required>{{ $phs->ketentuan }}</textarea>
                                            <div class="invalid-feedback">
                                                Form ketentuan tidak boleh kosong
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <button type="button" class="btn btn btn-light-dark close"
                    ...
                    <div class="modal fade bd-example-modal-l" id="hapusph-{{ $phs->id_penawaran }}" tabindex="-1"
                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body text-center">
                                    ...
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('penawaran-harga.removedph', ['id_penawaran' => $phs->id_penawaran]) }}"
                                        method="POST">
                                        @method('DELETE')
                                        @csrf
                    ...
                    <div class="modal fade bd-example-modal-xl" id="editphd-{{ $phd->id_detail_ph }}" tabindex="-1"
                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('penawaran-harga.updatephd', ['id_detail_ph' => $phd->id_detail_ph]) }}"
                                        method="POST" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="col-md-6">
                                            <label for="validationDefault04" class="form-label">PT Penerima</label>
                                            <select disabled class="form-select" id="cbe_pt" required>
                                                ...
                                                --}}
                                                <option
                                                    {{ $pen->id_pt_penerima == $phd->id_pt_penerima ? 'selected' : '' }}>
                                                    {{ $pen->id_pt_penerima }}--{{ $pen->nama_penerima }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                Form PT Penerima tidak boleh kosong
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom03" class="form-label">Estate</label>
                                            <select disabled name="id_pen-est" class="form-select" id="cbe_est"
                                                required>
                                                <option disabled value="">Pilih...</option>
                                                @foreach ($estate as $est)
                                                <option disabled
                                                    {{ $est->id_pt_penerima == $phd->id_pt_penerima ? 'selected' : '' }}
                                                    value="{{ $est->id_penerima }}">{{ $est->estate }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback">
                                                Form estate tidak boleh kosong
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">OA Kapal Kayu </label>
                                            <input name="oa_kk" type="number" value="{{ $phd->oa_kpl_kayu }}"
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom01" class="form-label">OA Container </label>
                                            <input name="oa_cont" type="number" value="{{ $phd->oa_container }}"
                                                class="form-control" id="validationCustom01"
                                                placeholder="Masukkan harga" required>
                                            <div class="invalid-feedback">
                                                Form harga tidak boleh kosong
                    ...
                    <div class="modal fade bd-example-modal-l" id="hapusphd-{{ $phd->id_detail_ph }}" tabindex="-1"
                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body text-center">
                                    <h5>Apakah anda yakin ingin hapus data ini?</h5>
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('penawaran-harga.removedphd', ['id_detail_ph' => $phd->id_detail_ph]) }}"
                                        method="POST">
                                        @method('DELETE')
                                        @csrf
                                        <div class="modal-footer justify-content-center">
                ...
                <x-slot:footerFiles>
                    ...
                    $(document).ready(function() {
                        ...
                        $('#validationDefault04').change(function() {
                            ...
                            if (selectedId !== '') {
                                $.ajax({
                                    url: "{{ route('getDetails', ['id' => ':id']) }}".replace(
                                        ':id', selectedId),
                                    type: 'GET',
                                    dataType: 'json',
                                        ...
                                        if (response.length > 0) {
                                            for (var i = 0; i < response.length; i++) {
                                                var option = "<option value='" + response[i]
                                                    .id_penerima + "' required>" + response[
                                                        i].estate + "</option>";
                                                $("#sel_emp").append(option);
                                            }
                                        } else {
                                            var option = "<option required value='" +
                                                response[i].id_penerima + "'>" + response[i]
                                                .estate + "</option>";
                                            $("#sel_emp").append(option);
                                        }
                                    },
