                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if(in_array('master-kapal-UPDATE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
                                                                ...
                                                                @endif
                                                                @if(in_array('master-kapal-DELETE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
