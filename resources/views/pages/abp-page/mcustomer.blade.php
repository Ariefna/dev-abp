                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if(in_array('master-customer-UPDATE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
                                                                ...
                                                                @endif
                                                                @if(in_array('master-customer-DELETE', Session::get('nama_action')) || Session::get('role') == 'superadmin')
