    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Data Port Of Destination</li>
            </ol>
        </nav>
    </div>
    <!-- /BREADCRUMB -->        
                ...
                <div class="widget-header">                                
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Form Data Port Of Destination</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area" style="padding: 1.5%;">
                    <form class="row g-3 needs-validation" action="{{ route('pod.store') }}"  method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="col-md-12">
                            <label for="validationCustom01" class="form-label">Nama Port Of Destination</label>
                            <input name="nama_pod" type="text" class="form-control" id="validationCustom01" placeholder="Masukkan nama Port Of Destination" required>
                            <div class="invalid-feedback">
                                Form nama Port Of Destination tidak boleh kosong
                            </div>
                        </div>
                        <div class="col-12">
        ...
        <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-header">                                
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Tabel Master Data Port Of Destination</h4>
                        </div>
                    </div>
                </div>
...
>>>>>>> Stashed changes
        ...
        @foreach ($pod as $pl)
        <div class="modal fade bd-example-modal-l" id="exampleModalHps-{{ $pl->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        <h5>Apakah anda yakin ingin hapus data ini?</h5>
                        <form class="row g-3 needs-validation" action="{{ route('pod.destroy', ['pod' => $pl->id]) }}"  method="POST">
                            @method('DELETE')
                            @csrf
