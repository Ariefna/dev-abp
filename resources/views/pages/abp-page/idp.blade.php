            ...
            <x-slot:scrollspyConfig>
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="padding: 1.5%;">
                                <form class="row g-3 needs-validation" action="{{ route('invoice-dp.store') }}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input readonly name="invoice_no" type="text" class="form-control"
                                            id="invoice_no" placeholder="Otomatis Generate">
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                                ...
                                <div class="col-lg-12">
                                    <div class="statbox widget box box-shadow">
                                        <div class="widget-content widget-content-area">
                                            ...
                                            @endif --}}
                                                            <td class="text-center">{!! $tdp->status == 2 ? '<span
                                                                    class="shadow-none badge badge-success">Approved</span>'
                                                                : ($tdp->status == 1 ? '<span
                                                            ...
                                                            <td class="text-center">
                                                                {!! $tdp->status == 1 ? '<a
                                                                    href="#modalIDPcur-'. $tdp->id_invoice_dp .'"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    data-bs-toggle="modal" data-placement="top"
                                                                    title="Invoice Curah">Curah</a>' : ($tdp->status ==
                                                                1 ?
                                                                '':'') !!}
                                                                {!! $tdp->status == 1 ? '<a
                                                                    href="#modalIDPcont-'. $tdp->id_invoice_dp.'"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    data-bs-toggle="modal" data-placement="top"
                                                                    title="Invoice Container">Container</a>' :
                                                                ($tdp->status
                                                                == 1 ? '':'') !!}
                                                                @if(in_array('finance-invoice-dp-APPROVE',
                                                                Session::get('nama_action')) || Session::get('role') ==
                                                                'superadmin')
                                                                {!! $tdp->status == 1 ? '<a
                                                                    href="'. route('invoice-dp.approve', ['id_invoice_dp' => $tdp->id_invoice_dp]) .'"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    id="approve-link" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Approve"
                                                                    data-original-title="Approve">Approve</a>' :
                                                                ($tdp->status == 2 ? '':'') !!}
                                                                @endif
                                                                {!! $tdp->status == 2 ? '<a
                                                                    href="'. route('invoice-dp.print',['id_invoice_dp'=>$tdp->id_invoice_dp]).'"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Print" data-original-title="Print">Print</a>'
                                                                :
                                                                ($tdp->status == 1 ? '':'') !!}
                                                                <a href="#modalIDPdetail-{{ $tdp->id_invoice_dp }}"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    data-bs-toggle="modal" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Detail"
                                                                    data-original-title="Detail">Detail</a>
                                                                @if(in_array('finance-invoice-dp-DELETE',
                                                                Session::get('nama_action')) || Session::get('role') ==
                                                                'superadmin')
                                                                <a href="{!!route('invoice-dp.delete',['id_invoice_dp'=>$tdp->id_invoice_dp])!!}"
                                                                    class="btn btn-outline-primary bs-tooltip me-2"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Delete"
                                                                    data-original-title="Delete">Delete</a>
                                                                @endif
                                                                {{-- <a href="#modalInvDP-{{ $tdp->id_track }}"
                                                                ...
                                                                {!! $tdp->status == 1 ? '<a
                                                                    href="'. route('invoice-dp.approve', ['id_invoice_dp' => $tdp->id_invoice_dp]) .'"
                                                                    id="approve-link" class="bs-tooltip"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Approve" data-original-title="Approve"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="20"
                                                                        height="20" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                ...
                                                                <a href="javascript:void(0);" class="bs-tooltip"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Print" data-original-title="Print"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="20"
                                                                        height="20" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                        ...
                        @foreach ($invdp as $tdp)
                        <div class="modal fade bd-example-modal-xl" id="modalIDPdetail-{{ $tdp->id_invoice_dp }}"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        Session::get('nama_action')) || Session::get('role') ==
                                                        'superadmin')
                                                        <a href="{{route('invoice-dp.deletedetail',['id_detail_dp'=>$item->id_detail_dp])}}"
                        ...
                        <div class="modal fade bd-example-modal-xl" id="modalIDPcur-{{ $tdp->id_invoice_dp }}"
                            tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalIDPcur">Tambah Detail Invoice DP Kapal Curah
                                        </h5>
                                    </div>
                                    <div class="modal-body">
                                        <form name="modal-detail" class="row g-3 needs-validation"
                                            action="{{ route('invoice-dp.savecurahidp') }}" method="POST"
                                            enctype="multipart/form-data" novalidate>
                                            @csrf
                                            <input type="hidden" name="id_track_i" id="id_track_i"
                                                value="{{ $tdp->id_track }}">
                                            <input type="hidden" name="id_invdp" id="id_invdp"
                                                value="{{ $tdp->id_invoice_dp }}">
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select cb_bypo" name="cb_bypo" required>
                                                    ...
                                                    <option value="{{ $gv->no_po }}({{ $gv->formatted_tgl_muat }})">
                                                        {{ $gv->no_po }}({{ $gv->formatted_tgl_muat }})</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3">
                                                <label for="notAllowCont" class="form-label">Total Tonase by
                                                    Date</label>
                                                <div class="input-group">
                                                    <input name="ttdb" step="any" min="0" id="ttdb" type="number"
                                                        class="form-control ttdb" readonly required>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="hrg_freight" step="any" min="0" id="hrg_freight"
                                                        type="text" class="form-control hrg_freight" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input name="total_harga" min="0" id="total_harga" type="text"
                                                        class="form-control total_harga" required>
                                                </div>
                                                <input type="hidden" name="sub_total" class="sub_total"
                                                    value="{{ $subtotal->where('id_track', $tdp->id_track)->first()?->sub ?? 0 }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label for="validationCustom01" class="form-label">Prosentase DP</label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">%</span>
                                                    <input name="prodp" step="any" min="0" max="100" type="number"
                                                        class="form-control prodp" required>
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input name="todp" min="0" type="text" class="form-control todp"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">%</span>
                                                    <input name="proppn" step="any" min="0" max="100" type="number"
                                                        class="form-control proppn" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input name="toppn" min="0" type="text" class="form-control toppn"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="modal-footer justify-content-center">
                                                ...
                                                <button id="btn-batal-{{ $tdp->id_invoice_dp }}" type="button"
                                                    class="btn btn btn-light-dark btn-batal">Batal</button>
                                            </div>
                                        </form>
                                    </div>
                        ...
                        <div class="modal fade bd-example-modal-xl" id="modalIDPcont-{{ $tdp->id_invoice_dp }}"
                            tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="modalIDPcont">Tambah Detail Invoice DP Kapal
                                            Container
                                        </h5>
                                    </div>
                                    <div class="modal-body">
                                        <form name="modal-tracking-ada" class="row g-3 needs-validation"
                                            action="{{ route('invoice-dp.savecontaineridp') }}" method="POST"
                                            enctype="multipart/form-data" novalidate>
                                            @csrf
                                            <input type="hidden" name="id_track_i" id="id_track_i"
                                                value="{{ $tdp->id_track }}">
                                            ...
                                            <div class="col-md-3">
                                                <label for="validationCustom04" class="form-label">PO Muat</label>
                                                <select class="form-select cb_bypocont" name="cb_bypocont"
                                                    id="cb_bypocont" required>
                                                    <option selected disabled value="">Pilih...</option>
                                                    @foreach($getvalcont->where('no_po',$tdp->no_po) as $gvc)
                                                    <option value="{{ $gvc->no_po }}({{ $gvc->formatted_tgl_muat }})">
                                                        {{ $gvc->no_po }}({{ $gvc->formatted_tgl_muat }})</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-3">
                                                <label for="notAllowCont" class="form-label">Total Tonase by
                                                    Date</label>
                                                <div class="input-group">
                                                    <input readonly name="ttdbcont" step="any" min="0" id="ttdbcont"
                                                        type="number" class="form-control ttdbcont" required>
                                                    <span class="input-group-text" id="inputGroupPrepend">KG</span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input readonly name="hrg_freightcont" step="any" min="0"
                                                        id="hrg_freightcont" type="text"
                                                        class="form-control hrg_freightcont" required>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="notAllowCont" class="form-label">Total Harga</label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input readonly name="total_hargacont" min="0" id="total_hargacont"
                                                        type="text" class="form-control total_hargacont" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <label for="validationCustom01" class="form-label">Prosentase DP</label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">%</span>
                                                    <input name="prodpcont" step="any" min="0" max="100" id="prodpcont"
                                                        type="number" class="form-control prodpcont" required>
                                                </div>
                                                <div class="invalid-feedback">
                                                    Masukkan prosentase dengan benar
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input name="todpcont" min="0" id="todpcont" type="text"
                                                        class="form-control todpcont" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <label for="notAllowCont" class="form-label">Prosentase PPn</label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">%</span>
                                                    <input name="proppncont" step="any" min="0" max="100"
                                                        id="proppncont" type="number" class="form-control proppncont"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-text" id="inputGroupPrepend">Rp</span>
                                                    <input name="toppncont" min="0" id="toppncont" type="text"
                                                        class="form-control toppncont" required>
                                                </div>
                                            </div>
                                            <div class="modal-footer justify-content-center">
                                                <button id="btn-modal-curah" type="submit"
                                                ...
                                                <button type="button" id="btn-batal"
                                                    class="btn btn btn-light-dark btn-batal" data-bs-dismiss="modal"><i
                        ...
                        $(document).ready(function() {
                            ...
                            function exportTableToExcel(tableId, filename) {
                                ...
                                var columnWidths = Array.from({
                                    length: ws["!ref"].split(":")[1].charCodeAt(0) - 'A'.charCodeAt(0) +
                                        1
                                }, () => 0);
                            ...
                            $('#cb_po').change(function() {
                                ...
                                $.ajax({
                                    type: 'GET',
                                    url: '/horizontal-dark-menu/finance/invoice-dp/get-invoice-number/' +
                                        id,
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.length > 0) {
                                                for (var i = 0; i < response.length; i++) {
                                                    $('input[name=ttdb]').val(parseFloat(
                                                            response[i].total_muat)
                                                        .toFixed(
                                                            0));
                                                    $('input[name=hrg_freight]').val(
                                                        formatter
                                                        .format(response[i].oa_kpl_kayu)
                                                        .replace('Rp', ''));
                                                    $('input[name=tgl_muat]').val(response[
                                                            i]
                                                        .tgl_muat)
                                                    var hrg_freight = response[i]
                                                        .oa_kpl_kayu;
                                                    var total_tonase = response[i]
                                                        .total_muat;
                                                    var total = hrg_freight * total_tonase;
                                                    $('input[name=total_harga]').val(
                                                        formatter
                                                        .format(total).replace('Rp', '')
                                                    );
                                                    console.log(muat);
                                                    console.log(harga);
                                                    console.log(total);
                                ...
                                if (selectedId !== '') {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            if (response.length > 0) {
                                                for (var i = 0; i < response.length; i++) {
                                                    $('input[name=ttdbcont]').val(
                                                        parseFloat(
                                                            response[i].total_muat)
                                                        .toFixed(
                                                            0));
                                                    $('input[name=hrg_freightcont]').val(
                                                        formatter.format(response[i]
                                                            .oa_container).replace('Rp',
                                                            '')
                                                    );
                                                    $('input[name=tgl_muatcont]').val(
                                                        response[
                                                            i].tgl_muat)
                                                    var hrg_freight = response[i]
                                                        .oa_container;
                                                    var total_tonase = response[i]
                                                        .total_muat;
                                                    var total = hrg_freight * total_tonase;
                                                    $('input[name=total_hargacont]').val(
                                                        formatter.format(total).replace(
                                                            'Rp', ''));
                            ...
                            $('.prodp, .proppn').on('input', function() {
                                ...
                                var total_harga = parseFloat(modal.find('.total_harga').val().replace(
                                    /\D/g,
                                    '')) || 0;
                                ...
                                modal.find('.toppn').val(formatter.format(total_ppn).replace(',', '.')
                                    .replace('Rp', ''));
                            });
                            $('.prodpcont, .proppncont').on('input', function() {
                                ...
                                var total_harga = parseFloat(modal.find('.total_hargacont').val()
                                    .replace(
                                        /\D/g, '')) || 0;
