        ...
        <x-slot:headerFiles>
            ...
            <x-slot:scrollspyConfig>
                ...
                <div class="row layout-top-spacing">
                                            ...
                                            @endif --}}
                                                        ...
                                                        <td class="text-center">
                                                            {!! $tdp->status == 1 ? '<a
                                                                ...
                                                                title="Invoice Curah">Curah</a>' : ($tdp->status == 1 ?
                                                            '':'') !!}
                                                            {!! $tdp->status == 1 ? '<a
                                                                href="#modalIDPcont-'. $tdp->id_invoice_dp.'"
                                                                class="btn btn-outline-primary bs-tooltip me-2"
                                                                data-bs-toggle="modal" data-placement="top"
                                                                title="Invoice Container">Container</a>' : ($tdp->status
                                                            == 1 ? '':'') !!}
                                                            ...
                                                            <a href="{!!route('invoice-dp.delete',['id_invoice_dp'=>$tdp->id_invoice_dp])!!}"
                                                                class="btn btn-outline-primary bs-tooltip me-2"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                title="Delete" data-original-title="Delete">Delete</a>
                                                            @endif
                    ...
                    <div class="modal fade bd-example-modal-xl" id="modalIDPcur-{{ $tdp->id_invoice_dp }}" tabindex="-1"
                    ...
                    <div class="modal fade bd-example-modal-xl" id="modalIDPcont-{{ $tdp->id_invoice_dp }}"
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalIDPcont">Tambah Detail Invoice DP Kapal Container
                                    </h5>
                                </div>
                                <div class="modal-body">
                                    <form name="modal-tracking-ada" class="row g-3 needs-validation"
                                        ...
                                        <div class="col-md-3">
                                            <label for="validationCustom04" class="form-label">PO Muat</label>
                                            <select class="form-select cb_bypocont" name="cb_bypocont" id="cb_bypocont"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" id="inputGroupPrepend">%</span>
                                                <input name="proppncont" step="any" min="0" max="100" id="proppncont"
                                                    type="number" class="form-control proppncont" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="notAllowCont" class="form-label">Total PPn</label>
                ...
                <x-slot:footerFiles>
                    ...
                    $(document).ready(function() {
                            ...
                            if (selectedId !== '') {
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        if (response.length > 0) {
                                            for (var i = 0; i < response.length; i++) {
                                                $('input[name=ttdbcont]').val(parseFloat(
                                                    response[i].total_muat).toFixed(
                                                    0));
                                                ...
                                                $('input[name=tgl_muatcont]').val(response[
                                                    i].tgl_muat)
                        ...
                        $('.prodp, .proppn').on('input', function() {
                            ...
                            var total_harga = parseFloat(modal.find('.total_harga').val().replace(/\D/g,
                                '')) || 0;
                        ...
                        $('.prodpcont, .proppncont').on('input', function() {
                            ...
                            var total_harga = parseFloat(modal.find('.total_hargacont').val().replace(
                                /\D/g, '')) || 0;
