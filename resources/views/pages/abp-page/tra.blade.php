        ...
        @vite(['resources/scss/dark/plugins/flatpickr/custom-flatpickr.scss']) --}}
            ...
            <x-slot:scrollspyConfig>
                ...
                <div class="row layout-top-spacing">
                    ...
                    <div id="basic" class="col-lg-12 col-sm-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="padding: 1.5%;">
                                <form class="row g-3 needs-validation" action="{{ route('tracking.store') }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input disabled name="no_pl" type="text" class="form-control" id="no_pl"
                                            required>
                                        <div class="invalid-feedback">
                                            ...
                                            <table id="style-3" class="table style-3 dt-table-hover"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($tra->total_qty , 0, ',', '.') }}</td>
                                                        @else
                                                        <td>{{ number_format($tra->qty_tonase_sisa , 0, ',', '.') }}
                                                        </td>
                                                        @endif
                                                        <td class="text-center"><span
                                                                class="shadow-none badge badge-danger">{{ $tra->status == 1 ? 'Pending' : '' }}</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($trac->muat_curah , 0, ',', '.') ?? '0' }}
                                                        </td>
                                                        <td>{{ number_format($trac->muat_container , 0, ',', '.') ?? '0' }}
                                                        </td>
                                                        <td>{{ number_format($trac->muat_container + $trac->muat_curah, 0, ',', '.') }}
                                                        </td>
                                                        <td>{{ number_format($trac->total_qty-($trac->muat_container + $trac->muat_curah) , 0, ',', '.') }}
                                                        </td>
                                                        <td class="text-center"><span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ number_format($trac->total_all_sisa , 0, ',', '.') }}
                                                        </td>
                                                        <td class="text-center"><span
                                                                class="shadow-none badge badge-danger">{{ $trac->status == 1 ? 'Pending' : '' }}</span>
                                                        </td>
                                            ...
                                            <table id="style-4" class="table style-4 dt-table-hover"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if(in_array('document-tracking-DELETE',
                                                            Session::get('nama_action')) || Session::get('role') ==
                                                            'superadmin')
                                                            <a href="#delete-{{ $tra->id_detail_track }}"
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('tracking.savecontainer') }}" method="POST"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group has-validation">
                                                <input name="tgl_muat" id="basicFlatpickr" value="2022-09-04"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" name="id_gudang" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($gudang as $gd)
                                                <option {{ $lastcont->id_gudang == $gd->id_gudang ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" name="id_kapal" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($kapal as $kpl)
                                                <option {{ $lastcont->id_kapal == $kpl->id ? 'selected' : '' }}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input name="voyage" type="text" value="{{ $lastcont->voyage }}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input name="no_container" value="{{ $lastcont->no_container }}"
                                                    type="text" value="" class="form-control" id="validationCustom01"
                                                    placeholder="Masukkan Nomor Container" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="validationCustom03" class="form-label">No Segel</label>
                                            <input name="no_segel" value="{{ $lastcont->no_segel }}" type="text"
                                                class="form-control" id="validationCustom01"
                                                placeholder="Masukkan No Segel" required>
                                        </div>
                                        @elseif ($lastcont==0)
                                        <div class="col-md-3">
                                            <label for="validationCustom03" class="form-label">Gudang Muat</label>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select" name="id_kapal" id="validationDefault01"
                                                ...
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($kapal as $kpl)
                                                <option value="{{ $kpl->id }}">{{ $kpl->kode_kapal }}
                                                    {{ $kpl->nama_kapal }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label for="validationCustom03" class="form-label">Voyage</label>
                                            <input name="voyage" type="text" value="" class="form-control"
                                                id="validationCustom01" placeholder="Masukkan Voyage" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="validationCustom03" class="form-label">Nopol</label>
                                            <input name="nopol" type="text" class="form-control" id="validationCustom01"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input name="no_segel" value="" type="text" class="form-control"
                                                id="validationCustom01" placeholder="Masukkan No Segel" required>
                                        </div>
                                        @endif
                                        @elseif($details==0 && $trackzero->count()==0)
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom03" class="form-label">Port Of Loading</label>
                                            <select class="form-select" name="cont_pol" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($pol as $pl)
                                                <option
                                                    {{ $selectpol->where('id_track',$tra->id_track)->contains('id_pol', $pl->id) ? 'selected' : '' }}
                                                    value="{{ $pl->id }}">{{ $pl->nama_pol }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="validationCustom03" class="form-label">Port Of
                                                Destination</label>
                                            <select class="form-select" name="cont_pod" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($pod as $pd)
                                                <option
                                                    {{ $selectpod->where('id_track',$tra->id_track)->contains('id_pod', $pd->id) ? 'selected' : '' }}
                                                    value="{{ $pd->id }}">{{ $pd->nama_pod }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @endif
                                        <div class="col-md-3">
                                            ...
                                            $tra->id_track)->where('tipe','Container')->count() > 0;
                                            @endphp
                                            @if ($lastcont || $match)
                                            @foreach ($getcontqty as $tra)
                                            <label for="notAllowCont" class="form-label">Quantity Tonases</label>
                                            <div class="input-group">
                                                <input name="qty_tonase" step="any" min="0" id="qty_cont" type="number"
                                                    class="form-control qty_cont" placeholder="QTY Tonase" required>
                                            ...
                                            <input name="qty_cont_total" id="qty_cont_total"
                                                value="{{ $tra->qty_tonase_sisa }}" type="hidden" step="any" min="0">
                                            <input type="hidden" name="qty_cont_ada" id="qty_sisa_cont" value="0"
                                                step="any" min="0">
                                            @endforeach
                                            ...
                                            <span class="shadow-none badge badge-danger mt-2">Sisa:
                                                {{ number_format($tra->qty2 , 0, ',', '.') }}</span>
                                            <div class="notAllowCont"></div>
                                            <input name="qty_cont_total" id="qty_cont_total" value="{{ $tra->qty2 }}"
                                                type="hidden" step="any" min="0">
                                            <input name="qty_cont_emp" id="qty_sisa_cont" value="0" type="hidden"
                                                step="any" min="0">
                                            @endforeach
                                            @endif
                                            @endforeach
                                    ...
                                    @if ($lastcont || $match)
                                        @foreach ($getcontqty as $tra)
                                            ...
                                            <span class="shadow-none badge badge-danger mt-2">Sisa: {{ number_format($tra->qty_tonase_sisa , 0, ',', '.')}}</span>
                                            <div class="notAllowCont"></div>
                                            <input name="qty_cont_total" id="qty_cont_total"
                                                value="{{ $tra->qty_tonase_sisa }}" type="hidden" step="any" min="0">
                                            <input type="hidden" name="qty_cont_ada" id="qty_sisa_cont" value="0"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input name="jml_sak" type="number" class="form-control"
                                                id="validationCustom01" placeholder="Jumlah Sak" required>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input name="qty_timbang" step="any" min="0" type="number"
                                                    class="form-control" placeholder="QTY Timbang" required>
                                                <span class="input-group-text" id="inputGroupPrepend">KG</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input name="hpp_kpl" type="number" value="" class="form-control"
                                                    id="validationCustom01" placeholder="Masukkan HPP Kapal" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group has-validation">
                                                <input name="no_sj" type="text" value="" class="form-control"
                                                    id="validationCustom01" placeholder="Masukkan Nomor Surat Jalan"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <form name="modal-tracking-ada" class="row g-3 needs-validation"
                                        action="{{ route('tracking.savecurah') }}" method="POST"
                                        enctype="multipart/form-data" novalidate>
                                        @csrf
                                        @if($trackzero->count()==0)
                                        @foreach ($tracknull as $tra)
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            <label for="validationCustom04" class="form-label">Tanggal Muat</label>
                                            <div class="input-group has-validation">
                                                <input name="tgl_muat" id="td" value="2022-09-04"
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom03" class="form-label">Port Of Loading</label>
                                            <select class="form-select" name="did_pol" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($pol as $pol)
                                                <option
                                        ...
                                        <div class="col-md-6">
                                            <label for="validationCustom03" class="form-label">Port Of
                                                Destination</label>
                                            <select class="form-select" name="did_pod" id="validationDefault01"
                                                required>
                                                <option selected disabled value="">Pilih...</option>
                                                @foreach ($pod as $pod)
                                                <option
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12">
                                            ...
                                            <div class="input-group">
                                                <input name="qty_tonase" id="qty_curah" type="number" step="any" min="0"
                                                    class="form-control qty_curah" placeholder="QTY Tonase" required>
                                                <span class="input-group-text" id="inputGroupPrepend">KG</span>
                                            </div>
                                            <span class="shadow-none badge badge-danger mt-2">Sisa:
                                                {{ number_format($tra->qty_tonase_sisa , 0, ',', '.') }}</span>
                                            ...
                                            <label for="validationMessage" class="form-label">Quantity Tonase</label>
                                            <div class="input-group">
                                                <input name="qty_tonase" id="qty_curah" type="number" value="0"
                    ...
                    <div class="modal fade bd-example-modal-l" id="delete-{{ $dd->id_detail_track }}" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-l modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body text-center">
                                    ...
                                    <form class="row g-3 needs-validation"
                                        action="{{ route('tracking.deletedata', ['id_track'=>$dd->id_track,'id_detail_track' => $dd->id_detail_track, 'tonase'=>$dd->qty_tonase]) }}"
                                        method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="modal-footer justify-content-center">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        ...
                        --}}
                        <form class="row g-3 needs-validation"
                            action="{{ route('tracking.destroy', ['tracking' => $tra->id_track]) }}" method="POST"
                            enctype="multipart/form-data" novalidate>
                            @method('DELETE')
                            @csrf
            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <td>{{ $tra->td_jkt }}</td>
                    <td>{{ $tra->eta }}</td>
                    <td class="text-center">{!! $tra->status == 1 ? '<span
                            class="shadow-none badge badge-success">Proses Muat</span>' : ($tra->status == 2 ? '<span
                            class="shadow-none badge badge-warning">Selesai Muat</span>' : '') !!}</td>
                    </tr>
                    @endforeach
                    </tbody>
                    </table>
