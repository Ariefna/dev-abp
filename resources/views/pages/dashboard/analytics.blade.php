                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('analytics.addsisatrack', ['no_po' => $trab->no_po]) }}"><div class="td-content"><span class="">{{ number_format($trab->qty_sisa, 0, ',', '.') }}&nbsp;KG</span></div></a></td>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('analytics.addsisadoor', ['id_dooring' => $trab->id_dooring]) }}"><div class="td-content"><span class="">{{ number_format($trab->qty_sisa, 0, ',', '.') }}&nbsp;KG</span></div></a></td>
                ...
                if (ParsedObject.settings.layout.darkMode) {
                    ...
                    */
                    ...
                    series: [
                    {
                        name: 'Pemasukan',
                        data: [
                                    @foreach ($datagrafik as $year => $total)
